      ...
      <div className="container container__about">
        <div className="about">
          ...
          <div className="about__content">
            <p className="about__content__paragraph-1">
            ...
            <p className="about__content__paragraph-2">
            ...
            <p className="about__content__paragraph-3">
            ...
            <div className="about__content__img-1 about__content__background">
              <figure className="about__content__figure">
                <img src={snowmanPicture} alt="Grade 4"/>
              </figure>
            </div>
            <div className="about__content__img-2 about__content__background">
              <figure className="about__content__figure">
                <img src={snowmanPicture} alt="Grade 4"/>
              </figure>
            </div>
            <div className="about__content__img-3 about__content__background">
              <figure className="about__content__figure">
                <img src={snowmanPicture} alt="Grade 4"/>
              </figure>
            </div>
